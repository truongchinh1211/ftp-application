...
public class TestRETRImage {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Call RETR command on image file path
        commandWriter.write(AESCipher.encrypt(AESKey.getBytes(), "RETR /users/testuser/bai3_3119410300_saudaiphat.png"));
        commandWriter.newLine();
        commandWriter.flush();
        System.out.println(AESCipher.decrypt(AESKey.getBytes(), commandReader.readLine()));
        String decrypted = AESCipher.decrypt(AESKey.getBytes(), dataReader.readLine());
        FileUtils.writeByteArrayToFile(new File("test.png"), Base64.getDecoder().decode(decrypted));
